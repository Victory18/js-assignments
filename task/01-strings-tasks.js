...
function encodeToRot13(str) {
    return str.replace(/[A-Za-z]/g, function(f) {
        return "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".charAt(
            "NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxyzabcdefghijklm".indexOf(f)
        );
    });
}
...
function isString(value) {
    return (typeof(value) == 'string' || toString.call(value) == '[object String]') ? true : false;
}
